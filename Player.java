...
public class Player extends Box {
  private Clock coolDown;     //clock for the cooldown time of each shot
  private double randomAngle;  //adds a random angle to every bullet fired
   private double currentSpeed;  //current speed of the bullet
     private int bombNumber;      //number of bombs in hand
     //constructor
  ...
  */
  ...
  /*changeCurrentSpeed
  * this method changes the current speed of the player
  */
   ...
   /*attack
  * this method lets player attack
  */
   public void attack(){
     //if cool down time has past
     if(coolDown.timePast()>=super.getCoolDownTime()){
       coolDown.upDate();
        
           //point - 0.2, shooting consumes points
